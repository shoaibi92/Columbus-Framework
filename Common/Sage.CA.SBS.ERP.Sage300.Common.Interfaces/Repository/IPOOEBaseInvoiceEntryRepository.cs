...
{
    /// <summary>
    /// PO OE Base Invoice Entry Repository Interface
    /// </summary>
    ...
    public interface IPOOEBaseInvoiceEntryRepository<THeader, TDetail1, TDetail2, TDetail3, TDetail4, TDetail5, TDetail6, TDetail7, TDetail8, TDetail9, TDetail10
        , TDetail11, TDetail12, TDetail13, TDetail14, TDetail15> : ISequencedHeaderDetailFiveRepository<THeader, TDetail1, TDetail2, TDetail3, TDetail4, TDetail5>
        ...
        where TDetail15 : POOEBaseInvoiceLineSerial, new()
    {
        ...
        THeader GetByIds<TInvoiceKey, TInvoiceSequenceKey>(TInvoiceKey invoiceKey, TInvoiceSequenceKey invoiceSequenceKey);
        ...
        /// <summary>
        /// Service Interface for New Reciept,Creates a new receipt
        /// </summary>
        /// <param name="pageNumber">The page number.</param>
        /// <param name="pageSize">Size of the page.</param>
        /// <param name="currentDetail">The current receipt.</param>
        /// <returns>returns POOEBaseInvoiceReciepts model</returns>
