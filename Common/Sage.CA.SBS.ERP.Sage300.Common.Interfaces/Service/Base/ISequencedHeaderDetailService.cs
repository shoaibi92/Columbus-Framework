...
namespace Sage.CA.SBS.ERP.Sage300.Common.Interfaces.Service.Base
{
    ...
    public interface ISequencedHeaderDetailService<THeader, TDetail> : IEntityService<THeader>, ISecurityService
        ...
        where TDetail : ModelBase, new()
    {
        ...
        void Refresh(THeader header);

        /// <summary>
        /// Get Page Data for details
        /// </summary>
