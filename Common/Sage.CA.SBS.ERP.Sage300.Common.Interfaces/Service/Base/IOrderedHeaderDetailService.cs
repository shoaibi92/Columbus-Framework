...
{
    /// <summary>
    /// Interface IOrderedHeaderDetailService Stateless
    /// </summary>
    /// <typeparam name="T"></typeparam>
    /// <typeparam name="TU">The type of the tu.</typeparam>
    public interface IOrderedHeaderDetailService<T, TU> : IEntityService<T>, ISecurityService
        ...
        where TU : ModelBase, new()
    {
        ...
        /// <returns></returns>
        EnumerableResponse<TU> GetDetail(int currentPageNumber, int pageSize, T model = null, Expression<Func<TU, Boolean>> filter = null,
