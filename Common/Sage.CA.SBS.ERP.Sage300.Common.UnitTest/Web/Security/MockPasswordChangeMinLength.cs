...
{
    /// <summary>
    /// Mock class for Password Change Minimum Length
    /// </summary>
    public class MockPasswordChangeMinLength : MockAuthenticationSessionBase
    {
        ...
        {
            // Mock password change minimum length
            authenticationResult.PasswordResult = new PasswordResult {MinimumPasswordLength = 64};
        }
        #endregion
    }
}
