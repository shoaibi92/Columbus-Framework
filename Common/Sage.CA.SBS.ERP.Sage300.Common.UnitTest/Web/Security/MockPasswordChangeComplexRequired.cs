...
{
    /// <summary>
    /// Mock class for Password Change Comnplex Password Required
    /// </summary>
    public class MockPasswordChangeComplexRequired : MockAuthenticationSessionBase
    {
        ...
        {
            // Mock password change complex password required
            authenticationResult.PasswordResult = new PasswordResult
            {
                MinimumPasswordLength = 0,
                PasswordChanged = false,
                PasswordException = PasswordException.ComplexPasswordRequired
            };
        }
        #endregion
    }
