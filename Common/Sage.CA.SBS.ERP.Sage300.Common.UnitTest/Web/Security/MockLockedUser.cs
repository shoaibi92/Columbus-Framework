...
{
    /// <summary>
    /// Mock class for Locked User
    /// </summary>
    public class MockLockeddUser : MockAuthenticationSessionBase
    {
        ...
        public override void Validate(string userId, string password, string company, AuthenticationResult authenticationResult)
        {
            ...
            throw new AuthenticationSessionException("Test user is locked", errorUserLocked, new Exception());
        }
        #endregion
    }
}
