...
{
    /// <summary>
    /// Mock class for Password Change Same Password
    /// </summary>
    public class MockPasswordChangeSamePassword : MockAuthenticationSessionBase
    {
        ...
        {
            // Mock password change same password
            authenticationResult.PasswordResult = new PasswordResult
            {
                MinimumPasswordLength = 0,
                PasswordChanged = false,
                PasswordException = PasswordException.SamePassword
            };
        }
        #endregion
    }
