...
{
    /// <summary>
    /// Mock class for Password Change Cannot Change Password
    /// </summary>
    public class MockPasswordChangeCannotChange : MockAuthenticationSessionBase
    {
        ...
        {
            // Mock password change cannot change password
            authenticationResult.PasswordResult = new PasswordResult
            {
                MinimumPasswordLength = 0,
                PasswordChanged = false,
                PasswordException = PasswordException.CannotChangePassword
            };
        }
        #endregion
    }
